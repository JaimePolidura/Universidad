package es.jaime.proyectofinal.gui.panellienzo;

import es.jaime.proyectofinal.AlmacenamientoFiguras;
import es.jaime.proyectofinal.Configuracion;
import es.jaime.proyectofinal.figuras.Elipse;
import es.jaime.proyectofinal.figuras.Rectangulo;
import es.jaime.proyectofinal.figuras.Texto;
