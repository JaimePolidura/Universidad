package es.jaime.datastructures.linkedlist;
...
public final class MyLinkedList<E> implements MyDataStructure<E>, Iterable<E> {
    // first -> ... -> last
    private Node<E> first;
    private Node<E> last;
    private int size;

    public MyLinkedList<E> insert(E element, int index) {
    ...
    public MyLinkedList<E> insert (E element) {
        if(isEmpty()){
            insertWhenEmpty(element);
        }else{
            insertLast(element);
    ...
    public MyLinkedList<E> remove(int index) {
        checkInsideBoundsOrThrow(index);
